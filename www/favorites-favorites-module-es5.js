...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["favorites-favorites-module"], {
  ...
  function srcAppFavoritesFavoritesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var FavoritesPage = /*#__PURE__*/function () {
      function FavoritesPage(appComponent, storage) {
      ...
      _createClass(FavoritesPage, [{
        ...
        value: function loadData(event) {
          ...
          this.storage.get('favoritePosts').then(function (res) {
            if (res) {
              _this2.posts = JSON.parse(res);
              _this2.posts = _this2.sortByMostRecent(_this2.posts);
              _this2.allPosts = _this2.posts;
              _this2.filteredPosts = _this2.posts;
              _this2.favoritePosts = _this2.posts;
            }
        ...
        key: "sortByMostRecent",
        value: function sortByMostRecent(posts) {
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('select', {
      "static": false
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonSelect"])], FavoritesPage.prototype, "select", void 0);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"]])], FavoritesPage);
    /***/
  }
}]);
