...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["posts-post-post-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPostsPostPostPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPostsPostPostRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    PostPageRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPostsPostPostModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPostsPostPostPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPostsPostPostPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var PostPage = /*#__PURE__*/function () {
      function PostPage(activatedRoute, router, wp, audioService, photoViewer, platform, actionSheetController, appComponent, storage) {
      ...
      _createClass(PostPage, [{
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    _context.next = 4;
                    return this.storage.get('favoritePosts').then(function (res) {
                      if (res) _this2.favoritePosts = JSON.parse(res);
                    });

                  case 4:
                    isFavorite = false;
                    if (this.favoritePosts) isFavorite = this.favoritePosts.find(function (post) {
                      return post.id.toString() == id;
                    }) ? true : false; // if local stored favorite-post, get post information from local storage

                    if (isFavorite) {
                      localPost = this.favoritePosts.find(function (post) {
                        return post.id.toString() == id;
                      });
                      ...
                      setTimeout(function () {
                        var _loop = function _loop() {
                          ...
                          image.onclick = function () {
                            _this2.photoViewer.show(image.src);
                          };
                        };

                        for (var _i = 0, _Array$from = Array.from(document.querySelectorAll('.postContent img')); _i < _Array$from.length; _i++) {
                          _loop();
                        }
                      }, 100);
                    } else {
                      this.wp.getPostContent(id).then(function (res) {
                        _this2.post = Object.assign({}, res.data, {
                          media_url: res.data._embedded['wp:featuredmedia'] ? res.data._embedded['wp:featuredmedia'][0].media_details.sizes.medium.source_url : undefined,
                          isFavorite: isFavorite,
                          views: res.data.views ? parseInt(res.data.views, 10) + 1 : 1
                        });

                        if (_this2.post.audio) {
                          _this2.audioService.loadNewAudio(_this2.post.audio, _this2.post.title.rendered);
                        }
                        ...
                        setTimeout(function () {
                          ...
                          for (var _i2 = 0, _Array$from2 = Array.from(document.querySelectorAll('.postContent img')); _i2 < _Array$from2.length; _i2++) {
                            _loop2();
                          }
                        }, 100);
                      });
                  ...
                  case 0:
                    actionButtons = [{
                      ...
                      handler: function handler() {
                        window.open(_this3.post.link, '_blank');
                      }
                    }];
                    ...
                    if (this.post.pdf) {
                      actionButtons.push({
                        ...
                        handler: function handler() {
                          window.open(_this3.post.pdf, '_blank');
                        }
                      });
                    }
        ...
        key: "setPostFavorite",
        value: function setPostFavorite() {
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    ...
                    _context3.next = 5;
                    return this.wp.getBase64ImgFromUrl(this.post.media_url).then(function (res) {
                      return _this4.post.base64Img = res;
                    });
                  ...
                  case 9:
                    ...
                    this.favoritePosts = this.favoritePosts.filter(function (post) {
                      return post.id != _this4.post.id;
                    });
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])('backButton', {
      "static": false
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:type", _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["IonBackButton"])], PostPage.prototype, "backButton", void 0);
    PostPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/posts/post/post.page.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./post.page.scss */
      "./src/app/posts/post/post.page.scss"))["default"]]
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], src_app_services_wp_service__WEBPACK_IMPORTED_MODULE_3__["WpService"], src_app_services_audio_service__WEBPACK_IMPORTED_MODULE_4__["AudioService"], _ionic_native_photo_viewer_ngx__WEBPACK_IMPORTED_MODULE_5__["PhotoViewer"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["Platform"], _ionic_angular__WEBPACK_IMPORTED_MODULE_6__["ActionSheetController"], src_app_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _ionic_storage__WEBPACK_IMPORTED_MODULE_8__["Storage"]])], PostPage);
    /***/
  }
}]);
//# sourceMappingURL=posts-post-post-module-es5.js.map