...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~posts-post-list-post-list-module~posts-post-post-module~settings-dataprot-dataprot-module~se~91884acd"], {
  ...
  /***/
  function node_modulesCapacitorCommunityHttpDistEsmIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "HttpPluginWeb", function () {
      return _web__WEBPACK_IMPORTED_MODULE_0__["HttpPluginWeb"];
    });
    /* harmony reexport (safe) */


    __webpack_require__.d(__webpack_exports__, "Http", function () {
      return _web__WEBPACK_IMPORTED_MODULE_0__["Http"];
  ...
  /***/
  function node_modulesCapacitorCommunityHttpDistEsmWebJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var HttpPluginWeb = /*#__PURE__*/function (_capacitor_core__WEBP) {
      _inherits(HttpPluginWeb, _capacitor_core__WEBP);

      var _super2 = _createSuper(HttpPluginWeb);
      ...
      _createClass(HttpPluginWeb, [{
        ...
        value: function request(options) {
          return __awaiter(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
            var fetchOptions, ret, contentType, data;
    ...
    Object(_capacitor_core__WEBPACK_IMPORTED_MODULE_0__["registerWebPlugin"])(Http); //# sourceMappingURL=web.js.map
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmCorePluginDefinitionsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmGlobalJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*! ./web-runtime */
    "./node_modules/@capacitor-community/http/node_modules/@capacitor/core/dist/esm/web-runtime.js"); // Create our default Capacitor instance, which will be
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmUtilJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebPluginsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebRuntimeJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebAccessibilityJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebAppJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebBrowserJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebCameraJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebClipboardJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebDeviceJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebFilesystemJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebGeolocationJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebLocalNotificationsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebModalsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebMotionJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebNetworkJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebPermissionsJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebShareJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebSplashScreenJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebStorageJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesCapacitorCommunityHttpNode_modulesCapacitorCoreDistEsmWebToastJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppServicesWpServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _capacitor_community_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    ...
    var Http = _capacitor_core__WEBPACK_IMPORTED_MODULE_4__["Plugins"].Http;
    ...
    var WpService = /*#__PURE__*/function () {
      ...
      _createClass(WpService, [{
        ...
        value: function getAllPosts() {
          return Http.request({
            method: 'GET',
            url: "".concat(this.url, "posts?_embed&per_page=100")
          });
        }
      }, {
        key: "getPosts",
        value: function getPosts() {
          ...
          return Http.request({
            method: 'GET',
            url: "".concat(this.url, "posts?_embed&per_page=10&page=").concat('' + page)
          });
        }
      }, {
        key: "getPostContent",
        value: function getPostContent(id) {
          return Http.request({
            method: 'GET',
            url: "".concat(this.url, "posts/").concat(id, "?_embed")
          });
        }
      }, {
        key: "getPageContent",
        value: function getPageContent(id) {
          return Http.request({
            method: 'GET',
            url: "".concat(this.url, "pages/").concat(id, "?_embed")
          });
        }
      }, {
        key: "getCategories",
        value: function getCategories() {
          return Http.request({
            method: 'GET',
            url: "".concat(this.url, "categories")
          });
        }
      }, {
        key: "getBase64ImgFromUrl",
        value: function getBase64ImgFromUrl(imageUrl) {
          var _this2 = this;

          return new Promise(function (resolve) {
            _this2.httpClient.get(imageUrl, {
              responseType: 'blob'
    ...
    WpService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Injectable"])({
      providedIn: 'root'
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])], WpService);
    /***/
  }
}]);
//# sourceMappingURL=default~posts-post-list-post-list-module~posts-post-post-module~settings-dataprot-dataprot-module~se~91884acd-es5.js.map