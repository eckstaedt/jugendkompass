...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["welcome-welcome-module"], {
  ...
  /***/
  function node_modulesCapacitorCommunityFcmDistEsmIndexJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "FCM", function () {
      return _plugin__WEBPACK_IMPORTED_MODULE_0__["FCM"];
  ...
  /***/
  function node_modulesCapacitorCommunityFcmDistEsmPluginJs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var FCMPlugin = _capacitor_core__WEBPACK_IMPORTED_MODULE_0__["Plugins"].FCMPlugin;

    var FCM = /*#__PURE__*/function () {
      function FCM() {
      ...
      _createClass(FCM, [{
         ...
         * @param options
         */
        value: function subscribeTo(options) {
          return FCMPlugin.subscribeTo({
            topic: options.topic
          });
        }
        /**
        ...
        key: "unsubscribeFrom",
        value: function unsubscribeFrom(options) {
          return FCMPlugin.unsubscribeFrom({
            topic: options.topic
          });
        }
        /**
  ...
  function srcAppWelcomeWelcomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _capacitor_community_fcm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    ...
    var fcm = new _capacitor_community_fcm__WEBPACK_IMPORTED_MODULE_4__["FCM"]();
    ...
    var WelcomePage = /*#__PURE__*/function () {
      function WelcomePage(router, storage) {
      ...
      _createClass(WelcomePage, [{
        ...
        value: function toHome() {
          PushNotifications.requestPermission().then(function (res) {
            if (res.granted) {
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _ionic_storage__WEBPACK_IMPORTED_MODULE_3__["Storage"]])], WelcomePage);
    /***/
  }
}]);
