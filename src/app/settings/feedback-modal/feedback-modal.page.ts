...
export class FeedbackModalPage implements OnInit {
  ...
  feedback: {
  ...
  }[] = [
    {
      id: 1,
      question:
        'Welche geistliche Themen würdest du gerne im Jugendkompass sehen?',
      answer: '',
    },
    {
      id: 2,
    ...
    },
    {
      id: 5,
      question:
        'Sind dir Funktionen aufgefallen, die in der App nicht so gut funktionieren und die man verbessern könnte? Wenn ja, welche?',
      answer: '',
    },
    {
      id: 6,
      question:
        'Ist die App deiner Meinung nach eine gute Alternative zum Telegram-Kanal bzw. der Print-Ausgabe?',
      options: [
        {
          id: 1,
          value: 'Keine Angabe',
    ...
    if (this.isValid()) {
      ...
      this.firebaseService
        ...
        .catch(async () => {
          const toast = await this.toastController.create({
            message:
              'Fehler beim Senden des Feedbacks. Probiere es später erneut.',
            color: 'danger',
            position: 'bottom',
            duration: 2000,
          });
